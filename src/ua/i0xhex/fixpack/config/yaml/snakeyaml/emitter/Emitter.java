...
public final class Emitter implements Emitable {
    ...
    private class ExpectStreamStart implements EmitterState {
        public void expect() throws IOException {
            if (event instanceof StreamStartEvent) {
                writeStreamStart();
                state = new Emitter.ExpectFirstDocumentStart();
            } else {
    ...
    private class ExpectDocumentStart implements EmitterState {
        ...
        public void expect() throws IOException {
            if (event instanceof DocumentStartEvent) {
                ...
                state = new Emitter.ExpectDocumentRoot();
            } else if (event instanceof StreamEndEvent) {
                ...
                // }
                writeStreamEnd();
                state = new Emitter.ExpectNothing();
            } else {
    ...
    private class ExpectDocumentEnd implements EmitterState {
        public void expect() throws IOException {
            if (event instanceof DocumentEndEvent) {
                ...
                flushStream();
                state = new Emitter.ExpectDocumentStart(false);
            } else {
    ...
    private class ExpectDocumentRoot implements EmitterState {
        public void expect() throws IOException {
            states.push(new Emitter.ExpectDocumentEnd());
    ...
    private void expectFlowSequence() throws IOException {
        ...
        state = new Emitter.ExpectFirstFlowSequenceItem();
    }
    ...
    private class ExpectFirstFlowSequenceItem implements EmitterState {
        public void expect() throws IOException {
            if (event instanceof SequenceEndEvent) {
                ...
                states.push(new Emitter.ExpectFlowSequenceItem());
    ...
    private void expectFlowMapping() throws IOException {
        ...
        state = new Emitter.ExpectFirstFlowMappingKey();
    }
        ...
        public void expect() throws IOException {
            if (event instanceof MappingEndEvent) {
                ...
                if (!canonical && checkSimpleKey()) {
                    states.push(new Emitter.ExpectFlowMappingSimpleValue());
                    expectNode(false, true, true);
                } else {
                    writeIndicator("?", true, false, false);
                    states.push(new Emitter.ExpectFlowMappingValue());
    ...
    private class ExpectFlowMappingSimpleValue implements EmitterState {
        public void expect() throws IOException {
            writeIndicator(":", false, false, false);
            states.push(new Emitter.ExpectFlowMappingKey());
            expectNode(false, true, false);
        }
    }
    ...
    private void expectBlockSequence() throws IOException {
        ...
        state = new Emitter.ExpectFirstBlockSequenceItem();
    }
    ...
    private class ExpectBlockSequenceItem implements EmitterState {
        ...
        public void expect() throws IOException {
            if (!this.first && event instanceof SequenceEndEvent) {
                ...
                states.push(new Emitter.ExpectBlockSequenceItem(false));
                expectNode(false, false, false);
            }
        }
    }
    ...
    private void expectBlockMapping() throws IOException {
        ...
        state = new Emitter.ExpectFirstBlockMappingKey();
    }
    ...
    private class ExpectBlockMappingKey implements EmitterState {
        ...
        public void expect() throws IOException {
            if (!this.first && event instanceof MappingEndEvent) {
                ...
                writeIndent();
                if (checkSimpleKey()) {
                    states.push(new Emitter.ExpectBlockMappingSimpleValue());
                    expectNode(false, true, true);
                } else {
                    writeIndicator("?", true, false, true);
                    states.push(new Emitter.ExpectBlockMappingValue());
                    expectNode(false, true, false);
                }
            }
        }
    ...
    private class ExpectBlockMappingSimpleValue implements EmitterState {
        public void expect() throws IOException {
            writeIndicator(":", false, false, false);
            states.push(new Emitter.ExpectBlockMappingKey(false));
            expectNode(false, true, false);
        }
    }
    ...
    private void processScalar() throws IOException {
        ...
        if (style == null) {
            ...
            switch (style) {
                case DOUBLE_QUOTED: case SINGLE_QUOTED:
